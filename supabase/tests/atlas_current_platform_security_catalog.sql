...
select is(
  ...
  jsonb_build_object(
    ...
    'private_function_count', 219,
    'private_function_catalog_md5', 'e0b2372a32a8817afd1c78960eed732e',
    'trigger_count', 94,
    'trigger_catalog_md5', '8d14708a2aadcef24acddf2bb0db1755',
    'positive_target_grant_count', 1503,
    'positive_target_grant_md5', '639a9a23e070ef2d1c1ae1949b7c0965',

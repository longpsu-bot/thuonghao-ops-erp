...
select is(
  ...
  jsonb_build_object(
    ...
    'private_function_count', 194,
    'private_function_catalog_md5', '16ca6073c118b645eb1510fdb5819d27',
    'trigger_count', 89,
    'trigger_catalog_md5', 'e1531e1b8fe24c8d365833705dd1b4df',
    'positive_target_grant_count', 1440,
    'positive_target_grant_md5', 'e9ca37d47f5b87933e0be8a385913130',

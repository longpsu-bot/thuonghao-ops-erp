...
select is(
  ...
  jsonb_build_object(
    ...
    'private_function_count', 204,
    'private_function_catalog_md5', '110c4866c142bc955ace08ef56492f56',
    'trigger_count', 89,
    'trigger_catalog_md5', 'e1531e1b8fe24c8d365833705dd1b4df',
    'positive_target_grant_count', 1459,
    'positive_target_grant_md5', '0a28d8224416810c2b7ee334522a7b32',

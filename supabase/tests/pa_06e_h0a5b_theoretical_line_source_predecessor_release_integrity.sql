...
begin
  ...
  values (p_snapshot, p_run, 'b5200000-0000-0000-0000-000000000400', 'b5200000-0000-0000-0000-000000000401', 1, 'b5200000-0000-0000-0000-000000000200', 1, 'b5200000-0000-0000-0000-000000000220', 'b5200000-0000-0000-0000-000000000300', 1, 'b5200000-0000-0000-0000-000000000320', 'b5200000-0000-0000-0000-000000000330', 3, 'b5200000-0000-0000-0000-000000000332', 'b5200000-0000-0000-0000-000000000700', 'b5200000-0000-0000-0000-000000000701', 1, timestamptz '2026-12-01 10:00:00+07' + p_attempt * interval '1 hour');
...
from (
  values
    (exists (select 1 from pg_indexes where schemaname = 'atlas_planning' and tablename = 'theoretical_need_lines' and indexname = 'theoretical_need_lines_recipe_atomic_anchor_key'), 'Recipe atomic source anchor remains unique inside the run'),

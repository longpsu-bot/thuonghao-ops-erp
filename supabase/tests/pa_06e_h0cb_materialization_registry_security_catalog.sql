...
select is((select count(*)::integer from pg_proc where pg_get_userbyid(proowner)='atlas_planning_command_runtime'), 4, 'PA-05D runtime still owns exactly four functions');

...
No Supabase credential or production-data access is required. The PA-04 migration can be verified against a disposable local PostgreSQL/Supabase-compatible database without linking a hosted project.
...
9. [`PA-04 — Supplier-direct Slice 1 Migration Foundation`](docs/architecture/pa-04-supplier-direct-slice-1-migration-foundation.md) — implemented migration scope, security posture, verification, exclusions, and next gates
10. The relevant contract under `docs/architecture/`
11. The corresponding GitHub issue and pull request

...
The H1A registry now recommends one exact controlled-Unit root, no Unit-dimension or contextual fallback, half-open service-date intervals, exact whole-tick representability, and stale revision rejection. Every H1A-P01 through H1A-P10 recommendation, including candidate `0.01 kg` and `1` steps, remains `PENDING_PRODUCT_OWNER_APPROVAL`; no production row or H1A SQL is approved.
...
H0C/CMD-15 is merged on baseline `5987f1fc9711b7bde094a610e598ff92d71e850d`. H1A0 product-decision preparation is the sole active Atlas task. H1A SQL, H1B1 decision persistence, and H1B2 review/preview/confirmation remain separately unapproved.

...
- 🟡 D-040 / PLANNING-CONTRACT-02B selective Confirmed Need continuity — implemented locally on its bounded draft branch; preserves exact unaffected human authority with private continuity evidence and leaves D-039 Recipe-replacement lineage and released downstream blockers unchanged
...
- 🟡 PLANNING-CONTRACT-02B selective Confirmed Need continuity — local implementation and certification complete pending draft PR review; adds private immutable carry/invalidation evidence, direct-or-carried decision authority, additive backend classifications/counts, and bounded Application presentation without public API/capability/lifecycle or D-039 semantic changes; [architecture](planning-contract-02b-selective-confirmation-continuity.md) and [implementation record](../implementation-tasks/TASK-PLANNING-CONTRACT-02B-selective-confirmation-continuity.md)

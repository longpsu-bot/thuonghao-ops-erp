...
- 🟡 PA-06E-H0 school-catering persistence and materialization architecture — [contract](pa-06e-h0-school-catering-persistence-and-materialization-contract.md), [decision](../decisions/decision-pa-06e-h0-source-lineage-and-decision-evidence.md), and [task](../implementation-tasks/TASK-PA-06E-H0-school-catering-persistence-materialization.md); H0A1 school/customer/location, H0A2 immutable Recipe/BOM, H0A3a Weekly Menu, H0A3b Attendance, H0A4a readiness decisions, and [H0A4b private readiness persistence](../implementation-tasks/TASK-PA-06E-H0A4b-planning-input-readiness-persistence.md) are merged; [H0A5a Need Generation decisions](../implementation-tasks/TASK-PA-06E-H0A5a-need-generation-decision.md) are closed under Issue #129 and pending independent review; H0A5b persistence and all later H0A/H0B/H0C work, H1, and remaining product decisions remain unapproved

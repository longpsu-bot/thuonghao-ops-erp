...
- 🟡 PLATFORM-PRE-H1A current test-catalog consolidation — implemented and locally validated under Issue #147 from baseline `35c626adc49d5c09102d8591f42100c0ded8b6c1`; 22/22 canonical, 18/18 affected historical suites, and 24 unique registered suites / 1,498 TAP results pass; pending draft-PR review, exact-head GitHub Actions, and merge; [implementation record](../implementation-tasks/TASK-PLATFORM-PRE-H1A-current-test-catalog-consolidation.md)

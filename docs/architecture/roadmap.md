...
- 🟡 PA-06E-H0 school-catering persistence and materialization architecture — [contract](pa-06e-h0-school-catering-persistence-and-materialization-contract.md), [decision](../decisions/decision-pa-06e-h0-source-lineage-and-decision-evidence.md), and [task](../implementation-tasks/TASK-PA-06E-H0-school-catering-persistence-materialization.md); H0A1 school/customer/location, H0A2 immutable Recipe/BOM, H0A3a Weekly Menu, H0A3b Attendance, H0A4a/H0A4b readiness, and H0A5a Need Generation decisions are merged; [H0A5b private Need Generation persistence](../implementation-tasks/TASK-PA-06E-H0A5b-need-generation-persistence.md) is implemented under Issue #131 and pending independent governance review; all later H0A/H0B/H0C work, H1, and remaining product decisions remain unapproved

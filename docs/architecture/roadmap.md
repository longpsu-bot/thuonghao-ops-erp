...
- 🟡 Connected school-catering Procurement PR A — implements NEED_GENERATION Handoff release, immutable Allocation Families, supplier splits/recommendations, shaped workbench and pre-PO D-042 rebalance; supplier/date PO draft and release remain the sequential PR-B boundary

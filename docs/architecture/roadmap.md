...
- 🟡 Connected school-catering Procurement backend — PR A implements NEED_GENERATION Handoff release, immutable Allocation Families, supplier splits/recommendations and the shaped workbench; PR B implements supplier/date PO drafts, stale successor regeneration, immutable release with backend numbering, shaped PO reads, and the D-042 DRAFT-versus-released commitment gate, pending exact-head review and merge

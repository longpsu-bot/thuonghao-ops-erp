...
- 🟡 PA-06E-H0 school-catering persistence and materialization architecture — [contract](pa-06e-h0-school-catering-persistence-and-materialization-contract.md), [decision](../decisions/decision-pa-06e-h0-source-lineage-and-decision-evidence.md), and [task](../implementation-tasks/TASK-PA-06E-H0-school-catering-persistence-materialization.md); the bounded [H0A1 school/customer/location](../implementation-tasks/TASK-PA-06E-H0A1-school-customer-location-foundation.md), [H0A2 immutable Recipe/BOM reference](../implementation-tasks/TASK-PA-06E-H0A2-recipe-bom-immutable-reference-foundation.md), and [H0A3a Weekly Menu persistence](../implementation-tasks/TASK-PA-06E-H0A3a-weekly-menu-persistence-foundation.md) foundations are merged, and the bounded [H0A3b Attendance persistence foundation](../implementation-tasks/TASK-PA-06E-H0A3b-attendance-persistence-foundation.md) is implemented pending review; H0A4 and all later H0A/H0B/H0C work, H1, and remaining product decisions remain unapproved

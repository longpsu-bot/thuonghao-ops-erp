...
- 🟡 PA-06E-H0 school-catering persistence and materialization architecture — [contract](pa-06e-h0-school-catering-persistence-and-materialization-contract.md), [decision](../decisions/decision-pa-06e-h0-source-lineage-and-decision-evidence.md), and [task](../implementation-tasks/TASK-PA-06E-H0-school-catering-persistence-materialization.md); the bounded H0A1 school/customer/location, H0A2 immutable Recipe/BOM reference, H0A3a Weekly Menu, and [H0A3b Attendance](../implementation-tasks/TASK-PA-06E-H0A3b-attendance-persistence-foundation.md) foundations are merged; [H0A4a Planning Input Readiness decisions](../implementation-tasks/TASK-PA-06E-H0A4a-planning-input-readiness-decision.md) are closed, and [H0A4b private readiness persistence](../implementation-tasks/TASK-PA-06E-H0A4b-planning-input-readiness-persistence.md) is implemented under Issue #127 pending draft-PR review; all later H0A/H0B/H0C work, H1, and remaining product decisions remain unapproved

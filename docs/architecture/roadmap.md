...
- 🟡 RMVP-05 connected Confirmed Need review and quantity confirmation — one shaped review, write-free exact preview, idempotent H1B1 confirmation command, and sixth Vietnamese Planning Inputs tab are implemented on a bounded draft branch; [API contract](../api/rmvp-05-connected-confirmed-need-review.md) and [implementation record](../implementation-tasks/TASK-RMVP-05-connected-confirmed-need-review.md). Exact-head GitHub validation and merge remain pending; validation, approval, release, CMD-03, downstream domains, hosted deployment, production policy seed, and Retool remain outside scope.
...
- 🟡 PA-06E-H1B2 authorized review/preview/confirmation — implemented as bounded RMVP-05 draft review; [exact API](../api/rmvp-05-connected-confirmed-need-review.md)
...
- 🟡 React connection for this path — bounded RMVP-05 sixth internal tab implemented in draft review

...
describe("Atlas staging dry-run and workflow", () => {
  ...
  it("makes both workflows call the shared repository certification entrypoints", () => {
    ...
    expect(SUPABASE_FULL_INTEGRATION_COMMANDS).toHaveLength(91);
    for (const masterDataRehearsalTest of [
      ...
      expect(SUPABASE_FULL_INTEGRATION_COMMANDS).toContainEqual({
        ...
        args: [
          ...
          "test",
          "db",
          `supabase/tests/${masterDataRehearsalTest}`,
          "--local",
        ],
      });
    }
    ...
    expect(SUPABASE_FULL_INTEGRATION_COMMANDS).toContainEqual({
      ...
      args: [
        ...
        "test",
        "db",
        "supabase/tests/master_data_creation_ux_02.sql",
        "--local",
      ],
    });
    expect(SUPABASE_FULL_INTEGRATION_COMMANDS).toContainEqual({
      ...
      args: [
        ...
        "test",
        "db",
        "supabase/tests/rmvp_02b_command_clock_skew.sql",
        "--local",
      ],
    });
    expect(
